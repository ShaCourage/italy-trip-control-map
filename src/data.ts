...
export const places: Place[] = [
  ...
  },
  {
    ...
    pairWith: ["st-peters-basilica", "castel-sant-angelo", "pompi-vatican"],
  ...
  },
  {
    ...
    koName: "Sant'Eustachio Il Caffe",
    category: "cafe",
    area: "중심부",
    lat: 41.8987,
    lng: 12.4749,
  ...
  },
  {
    ...
    girlsTripFit: 3,
    tags: ["점심", "로컬", "웨이팅"],
    why: "피렌체 점심 후보로 강하지만 운영시간 확인이 중요하다.",
    tips: ["영업일/시간 확인", "웨이팅 길면 시장으로 전환", "합석 가능성 감안"],
    pairWith: ["mercato-centrale", "duomo-florence"],
    sourceIds: ["restaurant-official"],
  },
  {
